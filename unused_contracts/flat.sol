...
/** Note from GET Protocol team. 
 * Sourced from Open ZeppelinV2.3.0: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.3.0/contracts/token/ERC20/IERC20.sol
 * No changes made to the code. This is orginal / stock OZ code. 
 * For questions contact: Kasper Keuenen (kasper at get-protocol.io)
 */
...
/** Note from GET Protocol team. 
 * Sourced from Open ZeppelinV2.3.0: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.3.0/contracts/token/ERC20/ERC20Detailed.sol
 * No changes made to the code. This is orginal / stock OZ code. 
 * For questions contact: Kasper Keuenen (kasper@get-protocol.io)
 */
...
/** Note from GET Protocol team. 
 * Sourced from Open ZeppelinV2.3.0: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.3.0/contracts/math/SafeMath.sol
 * No changes made to the code. This is orginal / stock OZ code. 
 * For questions contact: Kasper Keuenen (kasper at get-protocol.io)
 */
...
/** Note from GET Protocol team. 
 * Sourced from Open ZeppelinV2.3.0: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.3.0/contracts/token/ERC20/ERC20.sol
 * No changes made to the code. This is orginal / stock OZ code. 
 * For questions contact: Kasper Keuenen (kasper at get-protocol.io)
 */
